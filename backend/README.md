...
## Project Structure
    ...
    ├── test_community_temp_85869  # Django project configurations
...
1. Clone this repo and `cd test_community_temp_85869`
...
2. Clone this repo and `cd test_community_temp_85869`
